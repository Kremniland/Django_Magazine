...
# ListView
    ...
    path('', v.ListBooks.as_view(), name='book_list_class'),
...
# DetailView
    ...
    path('books/<int:book_id>/', v.DetailBook.as_view(), name='book_detail_class'),
...
# CreateView
    path('books/add/', v.CreateBook.as_view(), name='book_add_class'),

# UpdateView
    path('books/update/<int:book_id>', v.UpdateBook.as_view(), name='book_update_class'),
 
# DeleteView
    path('books/delete/<int:pk>', v.DeleteBook.as_view(), name='book_delete_class'),
...
# SESSION
    # path('set_session/', v.set_session_info),
    # path('get_session/', v.get_session_info),
